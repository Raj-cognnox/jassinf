                            ...
                            <div class="footer-widget info-widget">
                                <div class="widget-content">
                                    ...
                                    <ul class="contact-info">
                                        ...
                                        <li><span class="icon flaticon-call"></span><a href="tel:9780080903">9780080903</a></li>
                                        <li><span class="icon flaticon-email-2"></span><a
                                                href="mailto:jassinfotech@gmail.com">jassinfotech@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="inner clearfix">
                        <div class="copyright">&copy; copyright 2021 by jassinfotech.in</div>
                    </div>
                </div>
            </div>
